...
namespace NWS_Weather.Migrations
{
    ...
    [Migration("20200914131401_AddTopologySuite")]
    partial class AddTopologySuite
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NWS_Weather.Models.Geometry", b =>
                {
                    ...
                    b.Property<int?>("weatherStationpolygonId")
                        .HasColumnType("int");

                    b.HasKey("geometryId");

                    b.HasIndex("weatherStationpolygonId");
            ...
            modelBuilder.Entity("NWS_Weather.Models.WeatherStations", b =>
                {
            ...
            modelBuilder.Entity("NWS_Weather.Models.Geometry", b =>
                {
                    b.HasOne("NWS_Weather.Models.WeatherStations", "weatherStation")
                        .WithMany()
                        .HasForeignKey("weatherStationpolygonId");
                });
